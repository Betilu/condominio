#!/usr/bin/env python
"""
Script para probar el sistema simplificado de reconocimiento facial
"""
import os
import sys
import django
...
def test_simple_face_system():
    """Prueba el sistema simplificado de reconocimiento facial"""
    
    print("🔍 Probando sistema simplificado de reconocimiento facial...")
    ...
    # 3. Probar servicio simplificado
    if face_encodings.count() > 0:
        print(f"\n🧪 Probando reconocimiento facial simplificado...")
        ...
        try:
            ...
            attendance, confidence = face_service.record_attendance(
                ...
                notes='Prueba sistema simplificado'
            )
